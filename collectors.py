...
def collect_all():
    items=[]
    collectors=[collect_bofas,collect_boa,collect_bask,collect_bhs,collect_bess,collect_bscos,collect_bssh,collect_efas,collect_aofas,collect_efort,collect_ao]
